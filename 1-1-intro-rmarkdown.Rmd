...
![How it works](images/rmarkdownflow.png){fig.align=center}
...
If we think there is time we can add some additional code examples here:
...
Sharing can take many (and multiple) forms in RMarkdown:
...
You can create a dashboard in RMarkdown
